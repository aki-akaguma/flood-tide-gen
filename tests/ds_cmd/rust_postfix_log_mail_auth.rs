...
#[test]
fn gen_src_cmd() {
    assert!(std::fs::create_dir_all(test_out_path!("rust-postfix-log-mail-auth")).is_ok());
    //
    let r = do_gen_src(
        test_in_path!("ds-cmd/rust-postfix-log-mail-auth-cmd.txt"),
        test_out_path!("rust-postfix-log-mail-auth", "cmd.help.rs.txt"),
        test_out_path!("rust-postfix-log-mail-auth", "cmd.match.rs.txt"),
    );
    ...
    //
    compare_out_res!(
        "rust-postfix-log-mail-auth",
        "ds-cmd/rust-postfix-log-mail-auth",
        "cmd.help.rs.txt"
    );
    compare_out_res!(
        "rust-postfix-log-mail-auth",
